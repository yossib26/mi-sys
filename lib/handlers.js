...
async function duplicateCampaign(pool, id, brandScope) {
  ...
  const inserted = await pool.query(
    `INSERT INTO campaigns (brand_id, name, description, budget, start_date, end_date, status, template, banner, banner_mime, gift_mode, footer_note)
     VALUES ($1, $2, $3, $4, $5, $6, 'draft', $7, $8, $9, $10, $11) RETURNING id`,
    [o.brand_id, newName, o.description, o.budget, o.start_date, o.end_date, o.template, o.banner, o.banner_mime, o.gift_mode, o.footer_note]
  );
...
// — see ensureMarketingConsentField). A campaign with sync switched
